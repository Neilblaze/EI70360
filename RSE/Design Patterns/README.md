# Machine Learning Design patterns 🧠🏗️
...
A callback is a particular case of something called the Observer pattern so let's implement that. Code paraphrased from [here](https://refactoring.guru/design-patterns/observer/python/example#lang-features).
